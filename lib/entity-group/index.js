...
Group.prototype.create = function(id, components, state) {
  if (!components) {
    components = id;
...
Game.prototype.removeComponent = function(entity, component) {
  var system = this.getSystem(component);
  if (!system) throw new Error('No registered component: ' + component);
  system._unextend(entity);
}l
